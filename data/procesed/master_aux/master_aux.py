...
def calculate_df_aux(df_aux_result=None, type='day'):
    ...
    if type=='day':
        ...
        aux_summary=calculate_totals_columns(aux_summary=aux_summary)
        ...
        aux_summary_month=calculate_totals_columns(aux_summary=aux_summary)
...
def calculate_totals_columns(aux_summary=None):
...
def calculate_aux(df_master_aux=None, entidad=None, month_report=None, day_report=None):
    ...
    df_aux_result_day=calculate_df_aux(df_aux_result=df_aux_result_day, type='day')
    ...
    df_aux_result_month=calculate_df_aux(df_aux_result=df_aux_result_month, type='month')
    ...
    for week in range(df_master_aux['NUM_WEEK'].min(), df_master_aux['NUM_WEEK'].max(), 1):
        ...
        df_aux_result_week = calculate_df_aux(df_aux_result=df_aux_result_week, type='week')
